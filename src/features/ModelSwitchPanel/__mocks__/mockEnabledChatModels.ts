...
export const mockEnabledChatModels: EnabledProviderWithModels[] = [
  {
    ...
    id: 'openai',
    logo: 'https://registry.npmmirror.com/@agentasia/icons-static-png/1.45.0/files/dark/openai.png',
    name: 'OpenAI',
    source: 'builtin',
  },
  {
    ...
    id: 'azure',
    logo: 'https://registry.npmmirror.com/@agentasia/icons-static-png/1.45.0/files/dark/azure.png',
    name: 'Azure OpenAI',
    source: 'builtin',
  },
  {
    ...
    id: 'ollama',
    logo: 'https://registry.npmmirror.com/@agentasia/icons-static-png/1.45.0/files/dark/ollama.png',
    name: 'Ollama',
    source: 'builtin',
  },
  {
    ...
    id: 'openrouter',
    logo: 'https://registry.npmmirror.com/@agentasia/icons-static-png/1.45.0/files/dark/openrouter.png',
    name: 'OpenRouter',
    source: 'builtin',
  },
];
