...
// Bare GitHub issue references the model might emit without markdown
// link syntax. Used as a fallback so e.g. plain "#1234" inside the
// welcome still becomes clickable.
