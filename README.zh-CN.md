...
AgentAsia 帮你把专属 Agent 组织成 7×24 不打烊的高效队伍：
...
不论普通用户与专业开发者，AgentAsia 旨在成为所有人的 AI Agent 实验场。AgentAsia 目前正在积极开发中，有任何需求或者问题，欢迎提交 [issues][issues-link]

| [![](https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1065874&theme=light&t=1769347414733)](https://www.producthunt.com/products/agentasia?launch=agentasia-2&embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-agentasia) | 我们已在 Product Hunt 上线！我们很高兴将 AgentAsia 推向世界。如果您相信人类与 Agent 共同进化的未来，请支持我们的旅程。 |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------- |
| [![][discord-shield-badge]][discord-link]                                                                                                                                                                                                                          | 加入我们的 Discord 社区！这是你可以与开发者和其他 AgentAsia 热衷用户交流的地方                                         |
...
<details><summary><kbd>Star History</kbd></summary>
  <picture>
    ...
    <img src="https://api.star-history.com/svg?repos=agentasia%2Fagentasia&type=Date">
  </picture>
</details>
...
AgentAsia 是一个工作与生活空间，用于发现、构建并与会随着您一起成长的 Agent 队友协作。在 AgentAsia 中，我们将 **Agent 视为工作单元**，提供一个让人类与 Agent 共同进化的基础设施。
...
AgentAsia 引入了 **Agent Groups**，让您可以像对待真实队友一样与 Agent 协同工作。系统会为任务组装合适的 Agent，支持并行协作与迭代改进。
...
最好的 AI 是能深入理解您的那一种。AgentAsia 提供了构建清晰用户理解的 **个人记忆（Personal Memory）**。
...
AgentAsia 提供了 Vercel 的 自托管版本 和 [Docker 镜像][docker-release-link]，这使你可以在几分钟内构建自己的聊天机器人，无需任何基础知识。

> \[!TIP]
>
> 完整教程请查阅 [📘 构建属于自己的 AgentAsia][docs-self-hosting]
...
我们提供了一个用于在您自己的私有设备上部署 AgentAsia 服务的 Docker 镜像。请使用以下命令启动 AgentAsia 服务：
...
API Key 是使用 AgentAsia 进行大语言模型会话的必要信息，本节以 OpenAI 模型服务商为例，简要介绍获取 API Key 的方式。
...
- 将此 API Key 填写到 AgentAsia 的 API Key 配置中，即可开始使用。
...
| NPM                               | 仓库                                    | 描述                                                                                     | 版本                                      |
| --------------------------------- | --------------------------------------- | ---------------------------------------------------------------------------------------- | ----------------------------------------- |
| [@agentasia/ui][lobe-ui-link]       | [agentasia/lobe-ui][lobe-ui-github]       | 构建 AIGC 网页应用程序而设计的开源 UI 组件库                                             | [![][lobe-ui-shield]][lobe-ui-link]       |
| [@agentasia/icons][lobe-icons-link] | [agentasia/lobe-icons][lobe-icons-github] | 主流 AI / LLM 模型和公司 SVG Logo 与 Icon 合集                                           | [![][lobe-icons-shield]][lobe-icons-link] |
| [@agentasia/tts][lobe-tts-link]     | [agentasia/lobe-tts][lobe-tts-github]     | AI TTS / STT 语音合成 / 识别 React Hooks 库                                              | [![][lobe-tts-shield]][lobe-tts-link]     |
| [@agentasia/lint][lobe-lint-link]   | [agentasia/lobe-lint][lobe-lint-github]   | AgentAsia 代码样式规范 ESlint，Stylelint，Commitlint，Prettier，Remark 和 Semantic Release | [![][lobe-lint-shield]][lobe-lint-link]   |
...
插件提供了扩展 AgentAsia [Function Calling][docs-function-call] 能力的方法。可以用于引入新的 Function Calling，甚至是新的消息结果渲染方式。如果你对插件开发感兴趣，请在 Wiki 中查阅我们的 [📘 插件开发指引][docs-plugin-dev] 。

- [agentasia-chat-plugins][agentasia-chat-plugins]：插件索引从该仓库的 index.json 中获取插件列表并显示给用户。
- [chat-plugin-template][chat-plugin-template]：插件开发模版，你可以通过项目模版快速新建插件项目。
- [@agentasia/chat-plugin-sdk][chat-plugin-sdk]：插件 SDK 可帮助您创建出色的 AgentAsia 插件。
- [@agentasia/chat-plugins-gateway][chat-plugins-gateway]：插件网关是一个后端服务，作为 AgentAsia 插件的网关。我们使用 Vercel 部署此服务。主要的 API POST /api/v1/runner 被部署为 Edge Function。

> \[!NOTE]
>
> 插件系统目前正在进行重大开发。您可以在以下 Issues 中了解更多信息:
>
> - [x] [**插件一期**](https://github.com/node0datasystems-lgtm/agentasia-chat/issues/73): 实现插件与主体分离，将插件拆分为独立仓库维护，并实现插件的动态加载
> - [x] [**插件二期**](https://github.com/node0datasystems-lgtm/agentasia-chat/issues/97): 插件的安全性与使用的稳定性，更加精准地呈现异常状态，插件架构的可维护性与开发者友好
> - [x] [**插件三期**](https://github.com/node0datasystems-lgtm/agentasia-chat/issues/149)：更高阶与完善的自定义能力，支持插件鉴权与示例
...
> 同时欢迎联系我们提供产品功能和使用体验反馈，帮助我们将 AgentAsia 建设得更好。
>
...
[deploy-on-sealos-link]: https://template.hzh.sealos.run/deploy?templateName=agentasia-db
...
[docs]: https://agentasia.ai/zh/docs/usage/start
[docs-dev-guide]: https://agentasia.ai/docs/development/start
[docs-docker]: https://agentasia.ai/zh/docs/self-hosting/server-database/docker-compose
[docs-env-var]: https://agentasia.ai/docs/self-hosting/environment-variables
[docs-function-call]: https://agentasia.ai/zh/blog/openai-function-call
...
[github-action-release-link]: https://github.com/node0datasystems-lgtm/agentasia-chat/actions/workflows/release.yml
...
[github-action-test-link]: https://github.com/node0datasystems-lgtm/agentasia-chat/actions/workflows/test.yml
...
[share-mastodon-link]: https://mastodon.social/share?text=Check%20this%20GitHub%20repository%20out%20%F0%9F%A4%AF%20AgentAsia%20-%20An%20open-source,%20extensible%20(Function%20Calling),%20high-performance%20chatbot%20framework.%20It%20supports%20one-click%20free%20deployment%20of%20your%20private%20ChatGPT/LLM%20web%20application.%20https://github.com/node0datasystems-lgtm/agentasia-chat%20#chatbot%20#chatGPT%20#openAI
[share-mastodon-shield]: https://img.shields.io/badge/-share%20on%20mastodon-black?labelColor=black&logo=mastodon&logoColor=white&style=flat-square
[share-reddit-link]: https://www.reddit.com/submit?title=%E6%8E%A8%E8%8D%90%E4%B8%80%E4%B8%AA%20GitHub%20%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE