# 🤯 AgentAsia Desktop Application

AgentAsia Desktop is a cross-platform desktop application for [AgentAsia](https://github.com/node0datasystems-lgtm/agentasia-chat), built with Electron, providing a more native desktop experience and functionality.
...
- **🔗 Remote Server Sync**: Secure data synchronization with remote AgentAsia instances
...
1. Fork the [AgentAsia repository](https://github.com/node0datasystems-lgtm/agentasia-chat)
...
- **Issues & Support**: [GitHub Issues](https://github.com/node0datasystems-lgtm/agentasia-chat/issues)
