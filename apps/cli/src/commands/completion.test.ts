...
describe('completion command', () => {
  ...
  it('should output zsh completion script by default', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('compdef _agentasia_completion'));
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('lh lobe agentasia'));
