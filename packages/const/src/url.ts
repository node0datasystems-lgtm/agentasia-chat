...
export const OFFICIAL_URL = 'https://app.agentasia.ai';
export const OFFICIAL_SITE = 'https://agentasia.ai';
export const OFFICIAL_DOMAIN = 'agentasia.ai';

export const OG_URL = '/og/og.webp?v=1';

export const GITHUB = 'https://github.com/agentasia/agentasia-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://agentasia.ai/changelog';
...
export const FEEDBACK = 'https://github.com/agentasia/agentasia-chat/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat-plugins.agentasia.ai';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/agentasia/agentasia-chat/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/agentasia/agentasia-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/agentasia/agentasia-chat-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');
export const AGENTS_OFFICIAL_URL = 'https://agentasia.ai/agent';
...
export const BASE_PROVIDER_DOC_URL = 'https://agentasia.ai/docs/usage/providers';
export const CHANGELOG_URL = urlJoin(OFFICIAL_SITE, 'changelog');

export const DOWNLOAD_URL = {
  android: 'https://play.google.com/store/apps/details?id=com.agentasia.app',
