...
// readFile of .md / .json / .ts / etc. The lazy chunk back-referenced
// the main bundle for `detectUtf16NoBom`, causing the main entry to
// re-evaluate and re-register protocol schemes after app ready.
