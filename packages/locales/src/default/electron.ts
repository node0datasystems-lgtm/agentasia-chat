export default {
  ...
  'navigation.agentasia': 'AgentAsia',
  ...
  'remoteServer.configDesc': 'Connect to the remote AgentAsia server to enable data synchronization',
  ...
  'sync.agentasiaCloud.description': 'Officially provided cloud version',
  'sync.agentasiaCloud.title': 'AgentAsia Cloud',
