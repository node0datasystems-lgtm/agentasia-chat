export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@agentasia.ai</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@agentasia.ai</email>.',
  ...
  'createGuide.func1.title': 'Submit in AgentAsia',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the AgentAsia Community.',
  'footer.title': 'Share your creation on AgentAsia Community today',
  ...
  'models.providerInfo.apiTooltip': 'AgentAsia supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'AgentAsia Official Service',
  ...
  'skills.details.sidebar.platform.layout.agentasia': 'Skills are managed by AgentAsia automatically',
  ...
  'skills.details.sidebar.platform.steps.agentasia':
    'Install directly from the AgentAsia marketplace with one click.',
