export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve AgentAsia. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve AgentAsia',
  ...
  'screen5.actions.signInCloud': 'Sign in to AgentAsia Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your AgentAsia Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'AgentAsia Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own AgentAsia server instance',
