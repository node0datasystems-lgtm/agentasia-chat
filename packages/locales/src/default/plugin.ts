export default {
  ...
  'protocolInstall.official.badge': 'AgentAsia Official Skill',
  'protocolInstall.official.description': 'Official AgentAsia Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. AgentAsia does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'AgentAsia Skills',
