...
class AgentManagementExecutor extends BaseExecutor<typeof AgentManagementApiName> {
 ...
 // parent must keep the called sub-agent on the same path. See         const parentAgentConfig = conversationContext.agentId
 ...
 // TODO(follow-up): only client sub-agent dispatch is wired.
